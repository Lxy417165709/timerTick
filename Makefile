...
spider.o: ./src/spider.c
	$(AS) ${CFLAGS} ./src/spider.c

serial.o: ./src/serial.c
	$(AS) ${CFLAGS} ./src/serial.c
...
$(EXECUTABLE): main.o generic_timer.o system_counter.o startup.o gicv3_basic.o gicv3_cpuif.o el3_vectors.o spider.o serial.o led.o scatter.txt
	$(LD) --scatter=scatter.txt main.o generic_timer.o system_counter.o startup.o gicv3_basic.o gicv3_cpuif.o el3_vectors.o spider.o serial.o led.o -o $@ --entry=start64
